<?php
$pid = (int) ($record['id'] ?? 0);
$pacienteUuid = trim((string)($record['uuid'] ?? ''));
$plantaoLink = $pacienteUuid !== ''
    ? '/relatorio-plantao/paciente/' . rawurlencode($pacienteUuid)
    : '/relatorio-plantao';
?>
<section class="panel pac-panel-help">
    ...
    <p>
        <a class="btn btn-primary" href="<?= url($plantaoLink) ?>">Abrir plantão deste paciente</a>
