...
INSERT INTO `tb_contratos_paciente` (
    `id`,
    `uuid`,
    `paciente_id`,
    `tipo_servico`,
...
VALUES (
    1,
    '6ae2639f-52ac-11f1-a16a-089798669242',
    2,
    'Cuidados 24h',
    3000.00,
    10,
...
VALUES (1, 1, 1, 1, 1, 1, '2026-05-21 15:15:07'),
...
CREATE TABLE IF NOT EXISTS `tb_pacientes` (
  ...
  CONSTRAINT `fk_pacientes_responsavel` FOREIGN KEY (`responsavel_id`) REFERENCES `tb_responsavel` (`id`) ON DELETE
...
VALUES (
    ...
    'Alzheimer',
    'CID-10 G30',
    'Doença neurológica degenerativa de evolução lenta e progressiva',
    ...
    'Feminino',
    NULL,
    'Rua João Dornelas, 100 - Dornelas',
    '32 98888- 0000',
    NULL,
    'teste@ormezinda.com.br',
    'Lúcia',
    'Filha',
    '32 99999 - 0001',
    'lucia@teste.com.br',
    'Diabetes, pressão alta, incontinência urinária',
    'Nenhuma',
    'Nenhum',
    'O+',
    47.00,
  ...
  (
    12,
    '7ea9f297-59cc-11f1-b6c0-089798669242',
    'PRT-2026-7.0000',
    'Ana Luiza Martins',
    'Bronquiolite',
    'J21',
    'Bronquiolite aguda',
    'Necessidade de monitoramento respiratório',
    'Não',
    'Sim',
    'Não',
    'Não',
  ...
  (
    13,
    '7eaa931e-59cc-11f1-b6c0-089798669242',
    'PRT-2026-8.0000',
    'Lucas Gabriel',
    'Pneumonia',
    'J18',
  ...
  (
    14,
    '7eaa9966-59cc-11f1-b6c0-089798669242',
    'PRT-2026-9.0000',
    'Helena Souza',
  ...
  (
    15,
    '7eaa9dbb-59cc-11f1-b6c0-089798669242',
    'PRT-2026-10.000',
    'Miguel Oliveira',
    'Gastroenterite',
    'A09',
    'Gastroenterite infecciosa',
    'Hidratação e observação',
    'Não',
    'Não',
    'Não',
    'Não',
  ...
  (
    16,
    '7eaaa1f5-59cc-11f1-b6c0-089798669242',
    'PRT-2026-11.000',
    'Arthur Mendes',
    'Crise asmática',
    'J45',
  ...
  (
    17,
    'f13e2d18-59cc-11f1-b6c0-089798669242',
    'PRT-2026-12.000',
    'Ana Luiza Martins',
    'Bronquiolite',
    'J21',
  ...
  (
    18,
    'f13e356e-59cc-11f1-b6c0-089798669242',
    'PRT-2026-13.000',
    'Lucas Gabriel',
    'Pneumonia',
    'J18',
  ...
  (
    19,
    'f13e390a-59cc-11f1-b6c0-089798669242',
    'PRT-2026-14.000',
    'Helena Souza',
    'Pós-operatório cardíaco',
    'I51',
  ...
  (
    20,
    'f13e3c4b-59cc-11f1-b6c0-089798669242',
    'PRT-2026-15.000',
    'Miguel Oliveira',
    'Gastroenterite',
    'A09',
  ...
  (
    21,
    'f13e409b-59cc-11f1-b6c0-089798669242',
    'PRT-2026-16.000',
    'Arthur Mendes',
    'Crise asmática',
    'J45',
  ...
  (
    22,
    'f7a74bd9-59cc-11f1-b6c0-089798669242',
    'PRT-2026-17.000',
    'Ana Luiza Martins',
    'Bronquiolite',
    'J21',
  ...
  (
    23,
    'f7a754a3-59cc-11f1-b6c0-089798669242',
    'PRT-2026-18.000',
    'Lucas Gabriel',
    'Pneumonia',
    'J18',
  ...
  (
    24,
    'f7a7578c-59cc-11f1-b6c0-089798669242',
    'PRT-2026-19.000',
    'Helena Souza',
    'Pós-operatório cardíaco',
    'I51',
  ...
  (
    25,
    'f7a75a8d-59cc-11f1-b6c0-089798669242',
    'PRT-2026-20.000',
    'Miguel Oliveira',
    'Gastroenterite',
    'A09',
  ...
  (
    26,
    'f7a75d63-59cc-11f1-b6c0-089798669242',
    'PRT-2026-21.000',
    'Arthur Mendes',
    'Crise asmática',
    'J45',
  ...
  (
    27,
    '0e344e18-59cd-11f1-b6c0-089798669242',
    'PRT-2026-22.000',
    'Ana Luiza Martins',
    'Bronquiolite',
    'J21',
  ...
  (
    28,
    '0e3455fa-59cd-11f1-b6c0-089798669242',
    'PRT-2026-23.000',
    'Lucas Gabriel',
    'Pneumonia',
    'J18',
  ...
  (
    29,
    '0e345861-59cd-11f1-b6c0-089798669242',
    'PRT-2026-24.000',
    'Helena Souza',
    'Pós-operatório cardíaco',
    'I51',
  ...
  (
    30,
    '0e345ac7-59cd-11f1-b6c0-089798669242',
    'PRT-2026-25.000',
    'Miguel Oliveira',
    'Gastroenterite',
    'A09',
  ...
  (
    31,
    '0e345daa-59cd-11f1-b6c0-089798669242',
    'PRT-2026-26.000',
    'Arthur Mendes',
    'Crise asmática',
    'J45',
  ...
  (
    32,
    '0e2e80f2-5aa1-11f1-b6c0-089798669242',
    'PRT-2026-000001',
    'Ana Luiza Martins',
    'Bronquiolite',
    'J21',
